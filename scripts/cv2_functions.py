...
def put_stats_bar(frame, stats_dict: dict, bar_height=60,font_scale=0.5, font_thickness=1):
    ...
    navigation_text = f'Controls: IOU: "i" = +, "u" = -], Confidence: ["c" = +, "d" = -], Pred. Framerate: ["p" = +, "o" = -], Model: ["1" = M1, "2" = M2], Dist. test: ["t" = on, "z" = off], Blur: ["b" = on, "n" = off]'
...
def wait_for_key(stats_dict: dict):
    """
